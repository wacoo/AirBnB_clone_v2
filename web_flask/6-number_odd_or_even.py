...
def even_odd(n):
    ...
    n = int(n)
    if (n % 2) == 0:
        return "<!DOCTYPE html><html><head><title>HBNB</title></head><body><h1>Number: {} is even</h1></body></html>".format(n)
    elif (n % 2) != 0:
        return "<!DOCTYPE html><html><head><title>HBNB</title></head><body><h1>Number: {} is odd</h1></body></html>".format(n)
